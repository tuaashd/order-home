...
export default function HomePage({ categories, dishes }: Props) {
  return (
    <>
          ...
          <div className="grid flex-1 items-center gap-14 py-14 lg:grid-cols-[1.05fr_0.95fr] lg:py-8">
            <div className="max-w-2xl">
              ...
              <div className="fade-up-delay-3 mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <a
                  className="inline-flex items-center justify-center rounded-full border border-orange-300/25 bg-orange-400/10 px-7 py-4 text-sm font-semibold text-orange-100 transition hover:border-orange-300/40 hover:bg-orange-400/15 md:hidden"
                  href="#/admin"
                >
                  管理页面
                </a>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <article className="rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-orange-400/15 via-orange-200/5 to-transparent p-8 sm:p-10">
              ...
              <h2 className="section-title mt-5 max-w-lg">用一个强主推，拉住首屏转化。</h2>
            ...
            <aside className="flex flex-col justify-between rounded-[2.5rem] border border-white/10 bg-white/[0.04] p-8 sm:p-10">
              ...
              <div className="mt-10 rounded-[2rem] border border-dashed border-orange-300/25 bg-orange-300/[0.06] p-6">
                ...
                <p className="mt-4 text-sm leading-7 text-stone-300">三层信息足够支撑首屏转化，不需要把所有商品平铺上来。</p>
              </div>
            </aside>
          </div>
        </div>
          ...
          <div className="grid gap-14 lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <div className="space-y-4">
              {steps.map((step) => (
                ...
                >
                  <div className="font-display text-5xl text-white/80 transition group-hover:text-orange-300">{step.index}</div>
                  <div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-10">
          <div className="rounded-[2.8rem] border border-white/10 bg-gradient-to-r from-orange-400/18 via-orange-200/6 to-transparent px-8 py-10 sm:px-10 sm:py-12 lg:flex lg:items-end lg:justify-between">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row lg:mt-0">
              ...
              <a
                className="inline-flex items-center justify-center rounded-full border border-orange-300/25 bg-orange-400/10 px-7 py-4 text-sm font-semibold text-orange-100 transition hover:border-orange-300/40 hover:bg-orange-400/15"
                href="#/admin"
              >
                去管理页面
              </a>
